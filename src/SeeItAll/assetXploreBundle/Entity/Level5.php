 ...
 * Level5
 *
 * @ORM\Table(name="Level5")
 * @ORM\Entity(repositoryClass="SeeItAll\assetXploreBundle\Repository\Level5Repository")
...
//@ORM\JoinColumn(nullable=true) prohibits the creation of rooms without a level5
    ...
    */
     ...
     * @var string
     *
     * @ORM\Column(name="level5_name", type="string", length=255,  nullable=true)
     */
    private $level5Name;
...
// On ajoute cet attribut pour y stocker le nom du fichier temporairement
  ...
  public function setFile(UploadedFile $file)
  {
    ...
    if (null !== $this->level5Name) {
      // On sauvegarde l'extension du fichier pour le supprimer plus tard
      $this->tempFilename = $this->level5Name;


      // On réinitialise les valeurs des attributs url et alt
      $this->level5Image = null;
      $this->level5Name = null;
    }
  }
...
public function setUniqiD()
{
  ...
  public function preUpload()
  {
    ...
    $this->setUniqId();
    $this->level5Name = $this->file->getClientOriginalName();
 ...
 public function upload()
  ...
  public function preRemoveUpload()
  {
    ...
    $this->tempFilename = $this->getUploadRootDir().'/'.$this->level5Name;
  }
  ...
  public function generateThumbnail($img, $width, $height, $quality = 90)
  {
     ...
     * Set level5Name.
     *
     * @param string|null $level5Name
     *
     * @return Level5
     */
    public function setLevel5Name($level5Name = null)
    {
     ...
     * Set level5Image.
     *
     * @param string|null $level5Image
     *
     * @return Level5
     */
    public function setLevel5Image($level5Image = null)
    {
        $this->level5Image = $level5Image;
     ...
     * @return string|null
     */
    public function getLevel5Image()
    {
